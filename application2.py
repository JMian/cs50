...
def post_form():
    ...
    with open("survey.csv", "a") as file:
        ...
        writer.writerow({"firstname": request.form.get("firstname"), "lastname": request.form.get("lastname"), "gender": request.form.get("gender"), "region": request.form.get("region"), "qualification": request.form.get("qualification")})
